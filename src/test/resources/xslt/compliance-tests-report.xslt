    ...
    <xsl:function name="tests:tableHead" as="element(thead)" >
        <thead class="testshead">
            <tr class="centered testshead">
                <th class="centered col-0">#</th>
                <th class="centered col-1">Origin</th>
                <th class="centered col-2">Test Name</th>
                <th class="centered col-3">Passed</th>
                <th class="centered col-4">Parses</th>
                <th class="centered col-5">Query</th>
                <th class="centered col-6">QueryArg</th>
                <th class="centered col-7">Output Values</th>
                <th class="centered col-8">Output Paths</th>
            </tr>
        </thead>
    </xsl:function>
